...
export const VIDEOS = {
  ...
  // regenerate from the session scratchpad script; card copy is DRAFT
  // pending her sign-off.
  legoarch: [
    { src: 'legoarch/legoarch-60s-edit.mp4', name: 'demo', audio: true, posterAt: 22, crf: 23 },
  ],
  ...
  lungs: [
    { src: 'lungs/lungs-45s-edit.mp4', name: 'demo', audio: false, posterAt: 15, crf: 23 },
  ],
  sensi: [
  ...
  neurospace: [
    { src: 'neurospace/Images/neuro-recording-demo.mp4', name: 'slider-tour', audio: false, posterAt: 12, crf: 23, vf: 'crop=1280:630:0:56' },
  ],
}
